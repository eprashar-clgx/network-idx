...
BQ_TABLE_FCC_COVERAGE_BLOCK_PARITY = "fcc_coverage_block_parity"
...
BQ_TABLE_MONITORING_BASELINE = "monitoring_baseline"  # frozen distribution snapshots per run_id + kind (drift reference)
