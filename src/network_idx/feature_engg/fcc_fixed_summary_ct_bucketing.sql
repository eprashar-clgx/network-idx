...
SELECT 
    ...
    ROUND(copper_speed_1000_100_only,2) AS copper_speed_1000_100_only,
    ...
    ROUND(cable_speed_1000_100_only,2) AS cable_speed_1000_100_only,
    ...
    ROUND(fiber_speed_1000_100_only,2) AS fiber_speed_1000_100_only
FROM `{input_table}`