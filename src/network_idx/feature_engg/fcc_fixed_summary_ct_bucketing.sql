...
SELECT 
    ...
    ROUND(copper_speed_250_25_only + copper_speed_1000_100_only,2) AS copper_speed_more_than_100_20,
    ...
    ROUND(cable_speed_250_25_only + cable_speed_1000_100_only,2) AS cable_speed_more_than_100_20,
    ...
    ROUND(fiber_speed_250_25_only + fiber_speed_1000_100_only,2) AS fiber_speed_more_than_100_20
FROM `{input_table}`