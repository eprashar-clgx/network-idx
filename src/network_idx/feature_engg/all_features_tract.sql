...
SELECT 
    ...
    a.copper_speed_more_than_100_20,
    a.cable_speed_less_than_100_20,
    a.cable_speed_100_20_only,
    a.cable_speed_more_than_100_20,
    a.fiber_speed_less_than_100_20,
    a.fiber_speed_100_20_only,
    a.fiber_speed_more_than_100_20,
    -- custom calculation for map
    a.fiber_speed_100_20_only + a.fiber_speed_more_than_100_20 AS fiber_speed_equal_greater_than_100_20,
