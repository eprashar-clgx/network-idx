...
`geo` (geographic identifier lookup tables), `schemas` (the input and output column
contracts for each processing and feature table), and `scoring_contract` (the
parcel-level scoring feature buckets, weights, scaling rules, and delivery names).
