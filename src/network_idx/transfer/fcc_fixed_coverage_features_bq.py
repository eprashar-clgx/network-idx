...
Usage:
    ...
    python -m network_idx.transfer.fcc_fixed_coverage_features_bq --table tract --all

    # Upload block-level for selected states
    python -m network_idx.transfer.fcc_fixed_coverage_features_bq --table block --states AK AL

    # Upload county residuals, overwrite existing
    python -m network_idx.transfer.fcc_fixed_coverage_features_bq --table county_residuals --all --overwrite
"""
