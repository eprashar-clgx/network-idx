-- =============================================================================
-- County x technology fixed-coverage summary.
-- Module        : network_idx.features.telecom.transform.fcc_coverage_summary
-- Generated from : src/network_idx/features/telecom/transform/fcc_coverage_summary.py  (python -m network_idx.features.telecom.transform.fcc_coverage_summary --dry-run)
...
CREATE OR REPLACE TABLE `clgx-gis-app-dev-06e3.teu_telecom.fcc_coverage_summary`
...
WITH place_rows AS (
  ...
  FROM `clgx-idap-bigquery-prd-a990.edr_ent_common_reference_ext.fcc_fixed_broadband_summary_census`
...
county_rows AS (
  SELECT
    ...
    technology,
    speed_02_02, speed_10_1, speed_25_3, speed_100_20, speed_250_25, speed_1000_100
  FROM `clgx-idap-bigquery-prd-a990.edr_ent_common_reference_ext.fcc_fixed_broadband_geography`
  WHERE area_data_type = 'Total'
    AND biz_res = 'R'
