-- =============================================================================
-- Parcel growth-signal counts within radii.
-- Module        : network_idx.features.location.engineered.growth_counts
-- Generated from : src/network_idx/features/location/engineered/growth_counts.py  (python -m network_idx.features.location.engineered.growth_counts --dry-run)
...
CREATE OR REPLACE TABLE `clgx-gis-app-dev-06e3.teu_features.loc_growth_cnts_parcel`
...
spatial_matches AS (
    ...
    INNER JOIN flagged_targets t
        ON ST_DWITHIN(p.parcel_centroid, t.parcel_centroid, 402.336)
),
...
SELECT
    pf.parcel_shape_id,
    `carto-os`.carto.H3_FROMGEOGPOINT(pf.parcel_centroid, 8) AS h3_res8,  -- appended H3 index
